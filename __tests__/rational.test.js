...
describe("Testing the function make", () => {
    let ratCorr1, ratCorr2, ratCorr3;
    let ratNegative1, ratNegative2, ratNegative3;
    beforeEach(() => {
        ratCorr1 = make(3, 9);
        ratCorr2 = make(10, 3);
        ratCorr3 = ratCorr1.add(ratCorr2);
        ratNegative1 = make(-3, -9);
        ratNegative2 = make(-10, -3);
        ratNegative3 = ratNegative1.add(ratNegative2);
    });
    test("with empty values", () => {
        const emptyNumer = () => make();
        const emptyDenom = () => make(3);
        expect(() => emptyNumer().getNumer()).toThrow("The numerator must be of data type number!");
        expect(() => emptyDenom().getNumer()).toThrow("The denominator must be of data type number!");
    });
    describe("Testing the function getNumer", () => {
        ...
        test("with invalid values", () => {
            ...
            expect(() => invalidVal().getNumer()).toThrow("The numerator must be of data type number!");
        });
    });
    describe("Testing the function getDenom", () => {
        ...
        test("with invalid values", () => {
            const invalidVal = () => make(3, '9');
            expect(() => invalidVal().getNumer()).toThrow("The denominator must be of data type number!");
        });
    });
